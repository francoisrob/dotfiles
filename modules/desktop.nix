...
in {
  ...
  # The Thunderbolt-undock display recovery service that used to live here is
  # now in modules/system/laptop.nix -- it hardcodes eDP-1 and a dock hot-unplug
  # path, neither of which exists on the mini PC.
